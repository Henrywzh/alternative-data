...
const HK_TRANSPORT_ZH = {
  ...
  cards: {
    mtr_card: { description: "港铁月度总客运量，按本地及跨境服务拆解。", metricLabels: ["总客运量 (千人次)", "本地 (千人次)", "跨境 (千人次)"] },
    cathay_card: { description: "国泰集团月度载客人数、载客率及香港国际机场客运量。", metricLabels: ["国泰乘客人数", "载客率 (%)", "机场乘客人数"] },
  },
  charts: {
    mtr_service_chart: ["港铁客运量按服务类型走势 (千人次)", "本地重铁、跨境、高铁、机场快线及轻铁的月度乘客人次。", "月份", "千人次"],
    cathay_traffic_chart: ["国泰航空客运量与载客率 (%)", "国泰集团月度载客人数与载客率走势。", "月份", "乘客人数"],
  },
  tables: {},
  sources: {
