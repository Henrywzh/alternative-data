...
DATASET_REGISTRY: dict[str, dict[str, object]] = {
    ...
    "ramp_ai_pepm_spend_vintages": {
       "label": "Ramp AI Spend per Employee Vintages",
        "domain": "ramp",
        "natural_keys": ["date_month", "vintage_scraped_at"],
        "primary_date_column": "vintage_scraped_at",
        "metric_column": "median_pepm",
        "required_columns": ["date_month", "vintage_scraped_at", "median_pepm"],
    },
    "ramp_ai_pepm_spend_by_dimension_vintages": {
        "label": "Ramp AI Spend per Employee by Dimension Vintages",
        "domain": "ramp",
        "natural_keys": ["date_month", "dimension_type", "dimension_value", "vintage_scraped_at"],
        "primary_date_column": "vintage_scraped_at",
        "metric_column": "median_pepm",
        "required_columns": ["date_month", "dimension_type", "dimension_value", "vintage_scraped_at", "median_pepm"],
    },
    "ramp_ai_filter_pepm_vintages": {
        "label": "Ramp AI Filter-mode Spend per Employee Vintages",
        "domain": "ramp",
        "natural_keys": ["date_month", "business_office_state", "fte_segment", "naics_sector", "company_financing_status", "vintage_scraped_at"],
        "primary_date_column": "vintage_scraped_at",
        "metric_column": "median_pepm",
        "required_columns": ["date_month", "vintage_scraped_at", "median_pepm"],
    },
...
RAMP_LOAD_COLUMNS: dict[str, list[str]] = {
    ...
    "ramp_ai_pepm_spend_vintages": [
        *CORE_COLUMNS, "date_month", "vintage_scraped_at", "median_pepm", "p90_pepm", "p99_pepm",
        "p99_winsorized_weighted_pepm", "raw_weighted_pepm", "top_10_percent_median_pepm",
        "top_1_percent_median_pepm", "business_count", "spend_usd", "total_fte_denominator", "is_publishable",
    ],
    "ramp_ai_pepm_spend_by_dimension_vintages": [
        *CORE_COLUMNS, "date_month", "dimension_type", "dimension_value", "dimension_label",
        "display_order", "vintage_scraped_at", "median_pepm", "p99_winsorized_weighted_pepm",
    ],
    "ramp_ai_filter_pepm_vintages": [
        *CORE_COLUMNS, "business_office_state", "fte_segment", "naics_sector",
        "company_financing_status", "date_month", "is_latest_complete_month", "vintage_scraped_at",
        "median_pepm", "p90_pepm", "p99_pepm", "top_10_percent_median_pepm", "top_1_percent_median_pepm",
    ],
    "ramp_ai_jobs_impact": [
