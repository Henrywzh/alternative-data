            ...
            rows.append(
                {
                    ...
                    "valuation_scope_status": "latest_equity_basis_is_pit_aligned_through_1H2026; business_model_scope_requires_review",
                    ...
                    "risk_rule": "Do not approve from P/B alone; reconcile fleet/lease asset quality and reduce or exit if the operating KPI advantage reverses or spread drawdown breaches the risk budget.",
