...
PRICE_SOURCE_DEFAULTS: dict[str, PriceSourceRecord] = {
    ...
    "manganese": PriceSourceRecord(
        ...
        trackability_grade="proxy",
        price_source_type="investing_html",
        price_symbol_or_series_id="https://www.investing.com/commodities/zce-silicomanganese-futures-historical-data",
        price_currency="CNY",
        price_unit="ton",
        publish_lag_assumption_days=1,
        is_active_for_v1=True,
        proxy_target="silicomanganese_proxy",
    ),
    ...
    "silicon": PriceSourceRecord(
        ...
        trackability_grade="proxy",
        price_source_type="investing_html",
        price_symbol_or_series_id="https://www.investing.com/commodities/zce-ferrosilicon-futures-historical-data",
        price_currency="CNY",
        price_unit="ton",
        publish_lag_assumption_days=1,
        is_active_for_v1=True,
        proxy_target="ferrosilicon_proxy",
    ),
    ...
    "tantalum": PriceSourceRecord(
        ...
        trackability_grade="direct",
        price_source_type="investing_html",
        price_symbol_or_series_id="https://au.investing.com/commodities/tantalum-99.95-min-united-states-futures-historical-data",
        price_currency="USD",
        price_unit="kg",
        publish_lag_assumption_days=3,
        is_active_for_v1=True,
    ...
    "vanadium": PriceSourceRecord(
        ...
        trackability_grade="direct",
        price_source_type="investing_html",
        price_symbol_or_series_id="https://www.investing.com/commodities/vanadium-pentoxide-98-min-europe-futures-historical-data",
        price_currency="USD",
        price_unit="kg",
        publish_lag_assumption_days=1,
        is_active_for_v1=True,
